 ...
 */
public class CultureAdapter extends BaseListAdapter<Culture> {
    public CultureAdapter(Context context, int mode) {
        super(context, mode);
    }
    ...
    protected void onBindDefaultViewHolder(RecyclerView.ViewHolder h, int position) {
        ...
        Culture item = items.get(position);
        holder.tvTitle.setText(item.getCompanyCultureTitle());
        holder.tvContent.setText(item.getCompanyCulture());
    }
