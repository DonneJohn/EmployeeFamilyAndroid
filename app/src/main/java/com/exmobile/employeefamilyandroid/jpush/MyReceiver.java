package com.exmobile.employeefamilyandroid.jpush;
...
import com.exmobile.employeefamilyandroid.bean.JpushBean;
...
//			String message = bundle.getString(JPushInterface.EXTRA_MESSAGE);
            ...
            String url = api.substring(0, api.length() - 4) + "Appweb/NoticeDetail.aspx?RowID=" + jpushBean.getNoticeID();
            Intent i = new Intent(context, DetailActivity.class);
            i.putExtra(DetailActivity.KEY_URL, url);
            i.putExtra(DetailActivity.KEY_TITLE, "公告详情");
            i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
            context.startActivity(i);
