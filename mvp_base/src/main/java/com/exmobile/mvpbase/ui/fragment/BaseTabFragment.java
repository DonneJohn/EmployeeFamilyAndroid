...
public abstract class BaseTabFragment extends BaseFragment {
    ...
    public void addTab(String tag, Fragment fragment, int catalog) {
        Bundle bundle = new Bundle();
        bundle.putInt(BUNDLE_TYPE, catalog);
        mTabs.add(new ViewPageInfo(tag, Fragment.instantiate(getActivity(), fragment.getClass().getName(), bundle)));
